...
def house():
    input_path = 'C:/imgs/house/'
    camera_filepath = 'C:/imgs/house/3D/house.00{0}.P'
...
def dino():
    # Dino
    img1 = cv2.imread('C:/imgs/kinect/KinectScreenshot-Depth-02-20-01.png')
    img2 = cv2.imread('C:/imgs/kinect/KinectScreenshot-Depth-02-20-06.png')
    pts1, pts2 = features.find_correspondence_points(img1, img2)
    points1 = processor.cart2hom(pts1)
    points2 = processor.cart2hom(pts2)

    fig, ax = plt.subplots(1, 2)
    fig.suptitle('Correspondence Feature', fontsize=16)
...
ply = ply_processor.read_ply('out_4.ply')
cloud = ply['points']
print(cloud)
fig = plt.figure()
